...
namespace dkvr {
	...
	void TrackerUpdater::UpdateConnection(Tracker* target)
	{
		...
		case Tracker::ConnectionStatus::Handshaked:
		{
			...
			net_service_.QueueSending(target->address(), inst);
			break;
		}
		...
		case Tracker::ConnectionStatus::Connected:
		{
			...
			milliseconds timeout = std::chrono::duration_cast<milliseconds>(now_ - target->last_heartbeat_recv());
	...
	{
		using milliseconds = std::chrono::milliseconds;
		milliseconds duration = std::chrono::duration_cast<milliseconds>(now_ - target->last_heartbeat_sent());
	...
	{
		using milliseconds = std::chrono::milliseconds;
		milliseconds duration = std::chrono::duration_cast<milliseconds>(now_ - target->last_ping_sent());
